        ...
        if(this.props.file){
            ...
            if(filename != this.state.filename)
                this.props.file.async('text').then((fileContent)=>{
                    ...
                    if(['html', 'xhtml', 'htm'].includes(filenameExtension))
                        fileContent = beautify_html(fileContent);
                    else if(filenameExtension == 'xml')
                        fileContent = beautify_xml(fileContent);
                    else if(filenameExtension == 'js')
                        fileContent = beautify_js(fileContent);
                    else if(filenameExtension == 'css')
                        fileContent = beautify_css(fileContent);
