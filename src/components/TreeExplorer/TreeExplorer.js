    ...
    render() {
        return ( 
            <div className="tree-explorer">
                <TreeDirectory onClickDirectory={this.props.onClickDirectory} onClickFile={this.props.onClickFile} hideHeader={!this.props.rootDirName} directoryName={this.props.rootDirName} structure={this.props.structure}/>
            </div>
         );
    }
}
...
class TreeDirectory extends Component {
    ...
    onClickDirectory(e){
        ...
        if(this.props.onClickDirectory)
            this.props.onClickDirectory(this.props.directoryName, this.props.structure);
    }
    ...
    render() { 
        ...
        let children = Object.keys(this.props.structure).map((key, index) => {
            ...
            if(section.__isDirectory)
                return <TreeDirectory key={index} onClickFile={this.props.onClickFile} onClickDirectory={this.props.onClickDirectory} noIcon={section.__extraData?.noIcon} lockExpanded={section.__extraData?.lockExpanded} key={index} directoryName={key} structure={section}/>
            else
                return <TreeFile key={index} onClickFile={this.props.onClickFile} onkey={index} fileName={key} file={section}/>
        });
